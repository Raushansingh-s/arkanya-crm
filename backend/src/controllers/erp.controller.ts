  ...
  try {
    ...
    const course = await prisma.course.create({
      data: {
        ...
        semesterFees: semesterFees ? (parseFloat(semesterFees) || 0) : 0,
        registrationFees: registrationFees ? (parseFloat(registrationFees) || 0) : 0,
        examFees: examFees ? (parseFloat(examFees) || 0) : 0,
        hostelFees: hostelFees ? (parseFloat(hostelFees) || 0) : 0,
        seatsTotal: seatsTotal ? (parseInt(seatsTotal) || 0) : 60,
        seatsBooked: 0,
        seatsWaiting: 0
      }
    });
  ...
  try {
    ...
    const course = await prisma.course.update({
      ...
      data: {
        ...
        branch,
        eligibility,
        durationYears: durationYears ? (parseInt(durationYears) || undefined) : undefined,
        totalFees: totalFees ? (parseFloat(totalFees) || undefined) : undefined,
        semesterFees: semesterFees ? (parseFloat(semesterFees) || undefined) : undefined,
        registrationFees: registrationFees ? (parseFloat(registrationFees) || undefined) : undefined,
        examFees: examFees ? (parseFloat(examFees) || undefined) : undefined,
        hostelFees: hostelFees ? (parseFloat(hostelFees) || undefined) : undefined,
        seatsTotal: seatsTotal ? (parseInt(seatsTotal) || undefined) : undefined,
      }
    });
